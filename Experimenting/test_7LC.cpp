...
struct minHeap_7LCNode
{
    ...
    minHeap_7LCNode *F, *E, *D, *C, *B, *A, *Erase; // Left and right child
...
encode_info *score_7LC(const char *path, float accumulate, float alpha)
{
    ...
    encode_info *encode_info_7LC = (encode_info *)malloc(num * sizeof(encode_info));
    for (int i = 0; i < num; i++)
    {
...
{
    return !(root->F) && !(root->E) && !(root->D) && !(root->C) && !(root->B) && !(root->A) && !(root->Erase);
}
...
{
    struct minHeap_7LCNode *F = NULL, *E = NULL, *D = NULL, *C = NULL, *B = NULL, *A = NULL, *Erase = NULL, *top = NULL;
    ...
    if ((7 % 6) == (total_pattern % 6))
    {
        ...
        A = minHeap_7LC.top();
        minHeap_7LC.pop();
        Erase = minHeap_7LC.top();
        minHeap_7LC.pop();
        top = new minHeap_7LCNode(0, F->Freq_7LC + E->Freq_7LC + D->Freq_7LC + C->Freq_7LC + B->Freq_7LC + A->Freq_7LC + Erase->Freq_7LC);
        top->F = F;
        top->E = E;
        top->D = D;
        top->C = C;
    ...
    {
        cout << (6 % 6) << " = " << total_pattern << " mod 7 " << endl;
        E = minHeap_7LC.top();
        minHeap_7LC.pop();
        D = minHeap_7LC.top();
        minHeap_7LC.pop();
        ...
        Erase = minHeap_7LC.top();
        minHeap_7LC.pop();
        top = new minHeap_7LCNode(0, E->Freq_7LC + D->Freq_7LC + C->Freq_7LC + B->Freq_7LC + A->Freq_7LC + Erase->Freq_7LC);
        top->F = NULL;
        top->E = E;
        top->D = D;
        top->C = C;
    ...
    {
        cout << (5 % 6) << " = " << total_pattern << " mod 7 " << endl;
        D = minHeap_7LC.top();
        minHeap_7LC.pop();
        C = minHeap_7LC.top();
        minHeap_7LC.pop();
        ...
        Erase = minHeap_7LC.top();
        minHeap_7LC.pop();
        top = new minHeap_7LCNode(0, D->Freq_7LC + C->Freq_7LC + B->Freq_7LC + A->Freq_7LC + Erase->Freq_7LC);
        top->F = NULL;
        top->E = NULL;
        top->D = D;
        top->C = C;
    ...
    {
        cout << (4 % 6) << " = " << total_pattern << " mod 7 " << endl;
        C = minHeap_7LC.top();
        minHeap_7LC.pop();
        B = minHeap_7LC.top();
        minHeap_7LC.pop();
        ...
        Erase = minHeap_7LC.top();
        minHeap_7LC.pop();
        top = new minHeap_7LCNode(0, C->Freq_7LC + B->Freq_7LC + A->Freq_7LC + Erase->Freq_7LC);
        top->F = NULL;
        top->E = NULL;
        top->D = NULL;
        top->C = C;
    ...
    {
        cout << (3 % 6) << " = " << total_pattern << " mod 7 " << endl;
        B = minHeap_7LC.top();
        minHeap_7LC.pop();
        A = minHeap_7LC.top();
        minHeap_7LC.pop();
        Erase = minHeap_7LC.top();
        minHeap_7LC.pop();
        top = new minHeap_7LCNode(0, B->Freq_7LC + A->Freq_7LC + Erase->Freq_7LC);
        top->F = NULL;
        top->E = NULL;
        top->D = NULL;
        top->C = NULL;
    ...
    {
        cout << (2 % 6) << " = " << total_pattern << " mod 7 " << endl;
        A = minHeap_7LC.top();
        minHeap_7LC.pop();
        Erase = minHeap_7LC.top();
        minHeap_7LC.pop();
        top = new minHeap_7LCNode(0, A->Freq_7LC + Erase->Freq_7LC);
        top->F = NULL;
        top->E = NULL;
        top->D = NULL;
        top->C = NULL;
...
string decode_file(struct minHeap_7LCNode *root, string s)
{
    ...
    for (int i = 0; i < s.size(); i++)
    {
        ...
        // reached leaf node
        if (curr->F == NULL && curr->E == NULL && curr->D == NULL && curr->C == NULL && curr->B == NULL && curr->A == NULL && curr->Erase == NULL)
        {
            ans += curr->data;
            curr = root;
        }
