...
encode_info *score_5LC(const char *path, float accumulate, float alpha)
{
    ...
    encode_info *encode_info_5LC = (encode_info *)malloc((num+1) * sizeof(encode_info));
    for (int i = 0; i < num; i++)
    {
        ...
        encode_info_5LC[i].Before_ER = BeforeBER_OB->return_state(0);
        encode_info_5LC[i].Before_A = BeforeBER_OB->return_state(1);
        encode_info_5LC[i].Before_B = BeforeBER_OB->return_state(2);
        encode_info_5LC[i].Before_C = BeforeBER_OB->return_state(3);
        encode_info_5LC[i].Before_D = BeforeBER_OB->return_state(4);
        encode_info_5LC[i].Before_E = BeforeBER_OB->return_state(5);
        encode_info_5LC[i].Before_F = BeforeBER_OB->return_state(6);
        encode_info_5LC[i].Before_G = BeforeBER_OB->return_state(7);
        encode_info_5LC[i].After_ER = AfterBER_OB->return_state(0);
        encode_info_5LC[i].After_A = AfterBER_OB->return_state(1);
        encode_info_5LC[i].After_B = AfterBER_OB->return_state(2);
        encode_info_5LC[i].After_C = AfterBER_OB->return_state(3);
        encode_info_5LC[i].After_D = AfterBER_OB->return_state(4);
        encode_info_5LC[i].After_E = AfterBER_OB->return_state(5);
        encode_info_5LC[i].After_F = AfterBER_OB->return_state(6);
        encode_info_5LC[i].After_G = AfterBER_OB->return_state(7);
